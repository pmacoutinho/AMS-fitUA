        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_cardio_titulo),
                        childAtPosition(
                                ...
                                9),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("cardio - test"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.editText_pesos_titulo),
                        childAtPosition(
                                ...
                                9),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("pesos - test"), closeSoftKeyboard());
...
/*
        ...
        ViewInteraction materialRadioButton = onView(
                allOf(withId(R.id.radioButton4), withText("14h-14h30"),
                        childAtPosition(
        ...
        ViewInteraction materialRadioButton2 = onView(
                allOf(withId(R.id.radioButton2), withText("15h-15h30"),
                        childAtPosition(
                                allOf(withId(R.id.radioGroup_nutricao),
                                        childAtPosition(
                                                withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
...
*/
        ...
        ViewInteraction appCompatImageButton24 = onView(
                allOf(withId(R.id.imgButton_produtosPT),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatImageButton26 = onView(
                allOf(withId(R.id.imgButton_contactosPT),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
