...
public class CustomAdapter_TreinoCasa extends RecyclerView.Adapter<CustomAdapter_TreinoCasa.MyViewHolder> {

    private Context context;
    private Activity activity;
    private ArrayList id, casa, dificuldade, area, exercicios;

    CustomAdapter_TreinoCasa(Activity activity, Context context, ArrayList id, ArrayList casa,
    ...
    @NonNull
    public CustomAdapter_TreinoCasa.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.my_row_planos_treino, parent, false);
        return new CustomAdapter_TreinoCasa.MyViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    public void onBindViewHolder(@NonNull final CustomAdapter_TreinoCasa.MyViewHolder holder, final int position) {
        ...
        holder.mainLayoutPlanosTreino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, TreinoEmCasaActivity_2.class);
