...
public class TreinoNoGinasioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_treino_no_ginasio);
        ...
        CustomAdapter_TreinoGinasio customAdapterTreinoGinasio = new CustomAdapter_TreinoGinasio(this, this, id, casa, dificuldade, areas, exercicios);
        RecyclerView recyclerView = findViewById(R.id.recyclerViewTreinoGinasio);
        recyclerView.setAdapter(customAdapterTreinoGinasio);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

    void storeDataInArrays() {
        Cursor cursor = databaseHelper.readAllData("treinos_ginasio");
