...
public class CustomAdapter_PlanosTreino extends RecyclerView.Adapter<CustomAdapter_PlanosTreino.MyViewHolder> {

    private Context context;
    private Activity activity;
    private ArrayList id, casa, dificuldade, area, exercicios;

    CustomAdapter_PlanosTreino(Activity activity, Context context, ArrayList id, ArrayList casa,
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.mainLayoutPlanosTreino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, PlanosTreinoActivity_2.class);
